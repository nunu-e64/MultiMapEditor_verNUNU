...
Private Sub ShowChip_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)

    Call Me.ActiveForm.Form_KeyDown(KeyCode, Shift)
    ...
    If FormCounter <> 0 Then
        ...
        If 0 Then
            If ToolForm.Tool1.Buttons("Pen").Value = tbrUnpressed And ToolForm.Tool1.Buttons("Paint").Value = tbrUnpressed Then
                ...
                ToolForm.Tool1.Buttons("Paste").Enabled = False
...
Public Sub Top_bar_ButtonClick(ByVal Button As MSComctlLib.Button)
'ツールバーの処理
